module AptosShibaLocker::aptshiba_locker {
    ...
    public entry fun depositLockTimed<CoinType>(newAccount: &signer, lockAmount: u64, unlock_time: u64) acquires LockerState, LockerTimed, LockerEventHolder {
        ...
        let locker_state = borrow_global<LockerState>(@AptosShibaLocker);
        ...
        assert!(
            (locker_state.locker_live == true || account_address == @AptosShibaLocker),
        ...
        aptos_framework::aptos_account::transfer(newAccount, @AptosShibaLocker, locker_state.deposit_fee);
    ...
    public entry fun modifyDepositFee(deployerSigner: &signer, newDepositFee: u64) acquires LockerState {
        ...
        let locker_state = borrow_global_mut<LockerState>(@AptosShibaLocker); 
